...
### サイケデリックエフェクト
- **12種類のシェーダーパターン**: Psychedelic / Fractal / 39(初音ミク) / Rainbow Wave / Aurora / Voronoi / Interference / Hex Tunnel / Organic / Sparkles / Hearts / Caustic
...
├── Shaders/
│   └── PsychedelicShader.metal # Metal Compute Shader（12種のパターン）
└── Packages/
